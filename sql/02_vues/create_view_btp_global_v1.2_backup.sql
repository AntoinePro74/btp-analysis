...
-- Version : 1.2 (Ajout segmentation 3 niveaux : Premium/Prioritaire/Secondaire)
-- Date : 2026-02-08
-- 
-- Périmètre :
...
-- - Segmentation commerciale (3 flags)
-- 
-- Scoring optimisé :
...
-- - Cible Premium : Score ≥78 + 6-49 sal + APE ≥20 (~400 établissements)
-- - Cible Prioritaire : Score ≥70 + 1-49 sal + APE ≥20 (~7,000 établissements)
-- - Cible Secondaire : Score ≥52 + 1-49 sal (~150,000 établissements)
-- ============================================================================
...
SELECT 
  ...
  *,
  ...
  -- ========================================================================
  -- FLAG 1 : CIBLE PREMIUM (ultra-qualifiée pour Sales)
  -- ========================================================================
  -- Critères : Score ≥78 + 6-49 salariés + APE haute/moyenne
  -- Volume : ~400 établissements (0.04%)
  -- Usage : Prospection directe, démo personnalisée, offre premium
  CASE 
    WHEN (score_profil_territorial + score_taille_entreprise + 
          score_forme_juridique + score_potentiel_ape + bonus_multi_agences) >= 78 
  ...
  -- ========================================================================
  -- FLAG 2 : CIBLE PRIORITAIRE (élargie micro-entreprises)
  -- ========================================================================
  -- Critères : Score ≥70 + 1-49 salariés + APE haute/moyenne
  -- Volume : ~7,000 établissements (0.7%)
  ...
  -- ========================================================================
  -- FLAG 3 : CIBLE SECONDAIRE (potentiel moyen structuré)
  -- ========================================================================
  -- Critères : Score ≥52 + 1-49 salariés (tous APE)
  -- Volume : ~150,000 établissements (14%)
